...
import com.asifbuetme.youtubemp3mp4downloader.DialogConfigs;
...
class FileListAdapter extends BaseAdapter {
    ...
    FileListAdapter(ArrayList<FileListItem> listItem, Context context, DialogProperties properties) {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (item.isDirectory()) {
            ...
            holder.type_icon.setImageResource(R.drawable.ic_file_black_24dp);
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
    ...
    void setNotifyItemCheckedListener(NotifyItemChecked notifyItemChecked) {
