...
public class DirectoryPicker extends Dialog implements AdapterView.OnItemClickListener {
    ...
    public DirectoryPicker(Context context) {
        super(context);
    ...
    public DirectoryPicker(Context context, DialogProperties properties) {
        super(context);
        this.context = context;
