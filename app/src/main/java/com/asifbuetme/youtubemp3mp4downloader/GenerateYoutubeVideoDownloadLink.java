...
public class GenerateYoutubeVideoDownloadLink extends IntentService {
    ...
    public GenerateYoutubeVideoDownloadLink() {
        super("GenerateYoutubeVideoDownloadLink");
    }
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            ...
            for (int attemps = 1; attemps <= no_of_attemps; attemps++) {
                ...
                if (!file.exists()) {
                    if (isNetworkAvailable()) {
                        ...
                        stringHashMap.put("args[videoResolution]", "640x360");
                        ...
                        getDataFromInternet = new GetDataFromInternet(GenerateYoutubeVideoDownloadLink.this, "POST", stringHashMap, 15000);
                        ...
                        if (Integer.parseInt(dPageId) == 0) {
                            ...
                            getDataFromInternet = new GetDataFromInternet(GenerateYoutubeVideoDownloadLink.this, "GET", 15000);
                            ...
                            if (download_link.contains("title")) {
                                ...
                                getDataFromInternet = new GetDataFromInternet(GenerateYoutubeVideoDownloadLink.this, "HEAD", 15000);
                                ...
                                if (getDataFromInternet.client.getHeaderField("Content-Type").equals("video/mp4")) {
                                    ...
                                    Notification.Builder builder = new Notification.Builder(GenerateYoutubeVideoDownloadLink.this);
                                    ...
                                    Intent final_download_intent = new Intent(GenerateYoutubeVideoDownloadLink.this, DownloadYoutubeAudioOrVideoAfterComfirmation.class);
                                    ...
                                    builder.setContentIntent(PendingIntent.getService(GenerateYoutubeVideoDownloadLink.this, 302, final_download_intent, PendingIntent.FLAG_UPDATE_CURRENT));
                                ...
                                Log.e("DownloadYoutubeVideo", "Server Error!!  Trying again");
                            }
                        ...
                        isDownloadLinkValid = true;
                        notificationManager.notify(10002, new Notification.Builder(GenerateYoutubeVideoDownloadLink.this).setContentTitle("No Internet!!").setContentText("Internet isn't available..Check your internet settings").setSound(Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.failure)).setDefaults(Notification.DEFAULT_VIBRATE | Notification.DEFAULT_LIGHTS).setSmallIcon(R.drawable.ic_file_download_white_24dp).build());
                        break;
                    }
                } else {

                    isDownloadLinkValid = true;
                    notificationManager.notify(10002, new Notification.Builder(GenerateYoutubeVideoDownloadLink.this).setContentTitle("File Exits!!").setContentText("The file is already exits..No need to download").setSound(Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.failure)).setDefaults(Notification.DEFAULT_VIBRATE | Notification.DEFAULT_LIGHTS).setSmallIcon(R.drawable.ic_file_download_white_24dp).build());
                    break;
                }
            }
        } catch (Exception e) {
        ...
        if (!isDownloadLinkValid) {
            notificationManager.notify(10002, new Notification.Builder(GenerateYoutubeVideoDownloadLink.this).setContentTitle("Server is too busy now").setContentText("Server is busy").setSound(Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.failure)).setDefaults(Notification.DEFAULT_VIBRATE | Notification.DEFAULT_LIGHTS).setSmallIcon(R.drawable.ic_file_download_white_24dp).build());
        }
